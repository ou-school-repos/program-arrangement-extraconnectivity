...
A connected boundary-preserving simulated-annealing search over $160$ million
proposals found no configuration below the Hamming-ball boundary
$\SliceBoundary{}$.  This is heuristic evidence only and is not used in the
proof.
\end{remark}
