...
\]
For a finite family of sets, twice the excess incidence count is at most the
ordered pair-overlap count: an element of multiplicity $t$ contributes
$2(t-1)\leq t(t-1)$. Applied to the coordinate boundaries, this gives
$2X(S)$ no larger than the ordered overlap count. The global witness-pair
charging injection bounds that count by $2(R^2-R)$, hence
$X(S)\leq R(R-1)$. Substitution gives
\[
 |N(S)|\geq(Rk-E(R))(m+1)-Rk-R(R-1),
\]
