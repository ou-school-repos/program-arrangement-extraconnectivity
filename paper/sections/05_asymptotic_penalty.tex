...
right-hand side of \eqref{eq:sparse-limit} is $21$. Thus this displayed
inequality is retained only as a record of the abandoned heuristic and is not
used in any subsequent argument.
\end{remark}
...
by 464 vertices against the tested Star Graph and by 190 vertices against the
tested second-best connected subgraph. This is a fixed-topology asymptotic
comparison, not a proof that the Hamming Ball is the unique minimizer.
