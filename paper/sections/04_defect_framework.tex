...
evidence; the unrestricted form (without embedding conditions) is
refuted for general $R$ by the full-Star counterexample, but the restricted form
under $R \le 2^m$ holds throughout the embeddable range for $m \le 4$.
Conceptually,
