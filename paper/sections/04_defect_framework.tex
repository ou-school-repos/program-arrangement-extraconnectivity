...
\textup{(Conditional on the open Restricted Boundary Hypothesis
\ref{prop:restricted_lower_bound} and the Hamming-ball evaluation
\ref{prop:hb-eval}.)} Assume the hypercube embedding conditions
