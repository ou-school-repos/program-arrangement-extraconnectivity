...
\begin{conjecture}[Open Restricted Boundary Hypothesis]\label{prop:restricted_lower_bound}
...
\begin{proposition}[Finite computer-assisted certificates]
...
Hypothesis \ref{prop:restricted_lower_bound}.)} Assume the hypercube embedding conditions
$k \ge \lceil \log_2 R \rceil$ and $n-k \ge \lceil \log_2 R \rceil$.
Then for all $R \ge 2$:
	\begin{enumerate}
