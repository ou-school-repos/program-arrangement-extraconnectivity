...
induction schemes.  A coordinate-local incidence identity, at present
carried only as an unverified bookkeeping step (Section~\ref{sec:defect}),
would if established reduce one possible route to a coverage-avoidance
inequality for compatible projection sets, but the identity is not yet
proved and the inequality likewise remains unproved. A second, independent
gap --- the
