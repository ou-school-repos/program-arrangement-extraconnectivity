...
induction schemes.  Lemma~\ref{lem:local-collision} establishes the
coordinate-local identity, reducing one possible route to a
coverage-avoidance inequality for compatible projection sets, which
remains unproved. A second, independent
gap --- the
