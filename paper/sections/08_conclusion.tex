...
as detailed in Appendix~\ref{app:alt-strategies}, a substantive obstruction: the sharpest
currently available bound on shared external neighbors between two split
fibers is already tight at the configuration that refutes the natural
induction arguments, so closing the proposition requires a genuinely amortized
argument, not a sharper local one. A second, independent gap --- the
