...
$R$-vertex subgraph via the \texttt{nauty}-based engine (Section~3). Because
the proposition quantifies over \emph{all} $R$-vertex subsets, including
disconnected ones, this is only partial computational evidence; it remains
