...
Sorted by valid-vertex count `|V| = nP_k`.

| graph     |           ` |             V |   ` | `n^k` |   `R` |   `g` | Star boundary | Hamming baseline | `Δ` | `d,(k,n-k)` |
| --------- | ----------: | ------------: | --: | ----: | ----: | ----: | ------------: | :--------------- | --- | ----------- |
| `A(11,6)` |     332,640 |     1,771,561 |  31 |    30 |   450 |   476 |            26 | `5,(6,5)`        |
| `A(12,6)` |     665,280 |     2,985,984 |  37 |    36 |   630 |   687 |            57 | `6,(6,6)`        |
| `A(13,6)` |   1,235,520 |     4,826,809 |  43 |    42 |   840 |   921 |            81 | `6,(6,7)`        |
| `A(14,6)` |   2,162,160 |     7,529,536 |  49 |    48 | 1,080 | 1,163 |            83 | `6,(6,8)`        |
| `A(15,6)` |   3,603,600 |    11,390,625 |  55 |    54 | 1,350 | 1,441 |            91 | `6,(6,9)`        |
| `A(16,6)` |   5,765,760 |    16,777,216 |  61 |    60 | 1,650 | 1,713 |            63 | `6,(6,10)`       |
| `A(13,7)` |   8,648,640 |    62,748,517 |  43 |    42 |   882 | 1,029 |           147 | `6,(7,6)`        |
| `A(14,7)` |  17,297,280 |   105,413,504 |  50 |    49 | 1,176 | 1,366 |           190 | `6,(7,7)`        |
| `A(15,7)` |  32,432,400 |   170,859,375 |  57 |    56 | 1,512 | 1,744 |           232 | `6,(7,8)`        |
| `A(16,7)` |  57,657,600 |   268,435,456 |  64 |    63 | 1,890 | 2,112 |           222 | `6,(7,9)`        |
| `A(17,7)` |  98,017,920 |   410,338,673 |  71 |    70 | 2,310 | 2,658 |           348 | `7,(7,10)`       |
| `A(14,8)` | 121,080,960 | 1,475,789,056 |  49 |    48 | 1,176 | 1,423 |           247 | `6,(8,6)`        |
| `A(18,7)` | 160,392,960 |   612,220,032 |  78 |    77 | 2,772 | 3,200 |           428 | `7,(7,11)`       |
| `A(19,7)` | 253,955,520 |   893,871,739 |  85 |    84 | 3,276 | 3,783 |           507 | `7,(7,12)`       |
| `A(15,8)` | 259,459,200 | 2,562,890,625 |  57 |    56 | 1,568 | 1,903 |           335 | `6,(8,7)`        |
| `A(20,7)` | 390,700,800 | 1,280,000,000 |  92 |    91 | 3,822 | 4,356 |           534 | `7,(7,13)`       |
